# [3244. Shortest Distance After Road Addition Queries II][link] (Hard)

[link]: https://leetcode.cn/problems/shortest-distance-after-road-addition-queries-ii/
...
- There are no two queries such that `i != j` and `queries[i][0] < queries[j][0] < queries[i][1] <
queries[j][1]`.
